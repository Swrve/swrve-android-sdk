...
@Composable
private fun PushNotificationScreenPreviewLight() {
    PushNotificationSampleTheme(useDarkTheme = false) {
        PushNotificationScreen(
...
@Composable
private fun PushNotificationScreenPreviewDark() {
    PushNotificationSampleTheme(useDarkTheme = true) {
        PushNotificationScreen(
