...
public class SwrveFirebaseMessagingServiceTest extends SwrveBaseTest {
    ...
    public void testOnMessageReceived() {
        ...
        assertEquals(7, actualBundle.size());
        assertEquals("validBundle", actualBundle.getString("text"));
        ...
        assertEquals("0", actualBundle.getString("provider.priority"));
        assertEquals("0", actualBundle.getString("provider.original_priority"));
