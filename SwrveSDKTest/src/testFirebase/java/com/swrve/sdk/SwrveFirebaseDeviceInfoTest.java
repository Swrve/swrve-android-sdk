...
public class SwrveFirebaseDeviceInfoTest extends SwrveBaseTest {
            ...
            public void post(String endpoint, String encodedBody, IRESTResponseListener callback) {
                ...
                if (hasDeviceUpdateSent) {
                    try {
                        ...
                        Assert.assertEquals("firebase", attributeDevices.getString("swrve.sdk_flavour"));
                        Assert.assertEquals("google", attributeDevices.getString("swrve.app_store"));
                        Assert.assertEquals("android", attributeDevices.getString("swrve.os"));
    ...
    public void testUserContentParamsUponInit() {
        ...
        swrve.restClient = new IRESTClient() {
            ...
            public void get(String endpoint, Map<String, String> params, IRESTResponseListener callback) {
                ...
                if (hasCalledGET) {
                    Assert.assertEquals("android", params.get("os"));
