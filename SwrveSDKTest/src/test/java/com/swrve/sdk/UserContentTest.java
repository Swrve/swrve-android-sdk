        ...
        swrve.restClient = new IRESTClient() {
            ...
            public void get(String endpoint, Map<String, String> params, IRESTResponseListener callback) {
                ...
                if (hasCalledGET) {
                    ...
                    Assert.assertEquals("4", params.get("embedded_campaign_version"));
                    Assert.assertEquals("10", params.get("version"));
                    Assert.assertEquals("16", params.get("in_app_version"));
                    Assert.assertEquals("1", params.get("push_inbox_version"));
